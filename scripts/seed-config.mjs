...
export const cities = [
  ...
  },
  {
    ...
    topicAnchors: {
      ...
      neighborhood_vibe: ["mission bus stop after work", "sunset district quiet", "north beach block on a weekday"],
      ...
      ai_anxiety: ["ai therapist ad on the muni", "startup all-hands where nobody said the word layoff", "chatgpt answer to a sf specific question that was completely wrong but confident"],
      personal_story: ["roommate who left without notice", "layoff that came on a tuesday", "stranger at dolores park asking for a lighter", "the coffee shop where something changed"],
    },
